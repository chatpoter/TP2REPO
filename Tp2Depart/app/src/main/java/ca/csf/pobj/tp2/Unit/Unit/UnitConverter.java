...
//BEN_CORRECTION : Imports en trop.
...
public class UnitConverter {
    ...
    static {
        //BEN_REVIEW : À quoi sert ce Comparator ?
    ...
    //BEN_CORRECTION : Usage de classe enveloppe au lieu du type de base.
    public String convertIntToRomanString (Integer value){

        //BEN_REVIEW : Typo. Length, pas "lenght".
        int valueLenght = 4;
    ...
    private int[] valueToArray(int value){
        int temporaryValue = value; //BEN_CORRECTION : Variable redondante.
        int count = 4; //BEN_CORRECTION : Variable inutilisée.
        int[] divededNumber = new int[] {0,0,0,0};
        String valueSepareted = Integer.toString(value);


        //BEN_REVIEW : Boucle aurait pu être une boucle inversé.
        //             Tel que : for (int i = 3; i >= 0 ; i--){
        for (int i = 0; i < 4 ; i++){
